...
ggplot(all_rideable_type , aes(fill=user_type, y=number_of_rides, x=rideable_type)) + 
  geom_bar(position="dodge", stat="identity") + coord_flip() + labs(title= "Member Vs Casual rideable types")
...
ggplot(casual_data, aes(x=reorder(start_station_name, number_of_rides), y=number_of_rides, fill=number_of_rides)) + 
  ...
  labs(title= "Casual riders returning to same station as started",
       y= "casual_rides", x= "station_name") # Without stat='identity' ggplot wants to aggregate your data into counts
...
ggplot(member_data, aes(x=reorder(start_station_name, number_of_rides), y=number_of_rides, fill=number_of_rides)) + 
  geom_bar(stat='identity') + coord_flip() + labs(title="Member riders returning to same station as started",
